...
<%
   ...
   PreparedStatement ps=con.prepareStatement("insert into order_detail values(?,?,?,?,sysdate());");
   for(n=0;n<i;n++){
    ...
    <div class="modal-dialog modal-lg " >
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <table>
          <tr>
          <td Style="font-size:20px;text-align:left;">Name </td> <td Style="font-size:20px;">: </td> <td Style="font-size:20px;text-align:left;"><%out.println(" "+user);%></td>
         </tr>
          <tr>
          <td Style="font-size:20px;">Order No </td><td Style="font-size:20px;">: </td><td Style="font-size:20px;text-align:left;"><%out.println("A00"+order_no);%></td>
          </tr>
        ...
        <div class="col-sm-4">
          ...
          <button type="submit" class="btn btn-danger btn-default pull-left" data-toggle="modal" data-target="#statusModal" onclick="statusfunct()" >
        ...
        <div class="col-sm-8 pull-right">
         ...
         <div class="row">
         <hr>
         <p Style="font-size:15px;text-align:center;"><b><a href="#logoutModal" data-toggle="modal" data-target="#logoutModal">PLEASE LOG OUT FOR SECURITY REASONS</a></b><br>*This is computer generated bill and do not qualify for any legal claim.<br>The orginal bill will be sent with our delivery boy or sent through e-mail.</p>
         </div>
        </div>
      </div>
    </div>
...
<%
for(n=0;n<=i;n++){
out.println( itm_submit[n]+" old code");
 out.println(qty_submit[n]+"old qty");
}
session.removeAttribute("array_code");
session.removeAttribute("array_qty");
//itm_submit=(String[])session.getAttribute("array_code");
//qty_submit=(int[])session.getAttribute("array_qty");
for(n=0;n<=i;n++){
 out.println( itm_submit[n]+" present code");
 out.println(qty_submit[n]+"present qty");
}
%>
...
<div id="order" class="bg-1">
  <div class="container">
    <h2 class="text-center">PLEASE LOG-OUT FOR SECURITY REASONS<span class="glyphicon glyphicon-exclamation-sign"></span></h2>
    <div class="row">
  <div class="col-sm-4"></div>
  <div class="col-sm-4">


              <button  class="btn btn-block" data-toggle="modal" data-target="#logoutModal"><b>LOG-OUT</b>
...
<!--Status Modal -->
    ...
    <div class="modal-dialog">
	  ...
	  function statusfunct(){
	    ...
	    if(h < 101){
	      ...
	      if(h == 25)
	      document.getElementById("checkstat").innerHTML = "MAKING";
	      if( h == 50)
	   	  document.getElementById("checkstat").innerHTML = "BAKING";
	      if( h == 75)
	      document.getElementById("checkstat").innerHTML = "PACKING";
	      if( h == 100)
	      document.getElementById("checkstat").innerHTML = "DISPATCHED";
	    } else {
  ...
  <div class="progress">
   ...
   <h4 id="checkstat"> ORDER RECEIVED</h4>
...
<div id="feedback" class="container">
  ...
  <p class="text-center"><em>We love to help our Coustmers!</em></p>
...
<footer class="text-center">
  ...
  <p style="font-size:20px">Developed & Maintained by</p><p style="font-size:45px"><a data-toggle="tooltip" title="Code to view the next"><Span class="ion-ios-wineglass"style="font-size:70px;"></Span></style></a></p>
