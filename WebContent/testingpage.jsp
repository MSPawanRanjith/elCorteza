  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <!-- <p><span class="glyphicon glyphicon-phone"></span>Phone: +00 1515151515</p> -->
       ...
       <div class="col-sm-4">
          <form role="cartform" method="post" action="">

              <button type="submit" class="btn btn-block"><b>View Cart</b>
    ...
    <div class="row text-center">
      <div class="col-sm-4">
        <div class="thumbnail">
          ...
          <form name="itmform" role="form"  method="post" action="testingpage.jsp">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <p><b>Do you want to Log Out ?</b></p>
          <form role="form" name="logoutform" method="post" action="index.jsp">
