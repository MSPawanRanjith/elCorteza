...
<%
 ...
 // out.println(strn +"   "+strm+"  ");
  if(strn != null && strm != null){
		  ...
		  itmcode[i]=(String)session.getAttribute("itmcode");
   	      qty[i]=Integer.parseInt((String)session.getAttribute("qty"));
   	      previtmcode=itmcode[i];
   	      prevqty=qty[i];
		  //out.println(itmcode[i]+"  "+qty[i]+"  "+i.intValue());
		  i = new Integer(i.intValue() + 1);
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
       ...
       Class.forName("com.mysql.jdbc.Driver");
		...
		Statement stmts=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
  ...
  <div class="modal fade" id="cartModal" role="dialog">
    <div class="modal-dialog ">
      ...
      <div class="modal-content">
        ...
        <div class="modal-bodycart"style="overflow-y: scroll; max-height:85%;  margin-top: 0px; margin-bottom:0px;">
        <%!String itmname;int itmcost; int total; %>
        <%
       //Class.forName("com.mysql.jdbc.Driver");
		//Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/elcorteza","root","network");
        ...
        <tbody>
         <%if(itmcode[0]!=null){
           ...
           for(int j=0;j<i;j++){
        	   ...
        	   out.println("<td>");
        	   String select="select * from menu where(itm_code="+Integer.parseInt(itmcode[j])+");";
        	   ResultSet rs= stmt.executeQuery(select);
        	   while(rs.next()){
        		   itmname=rs.getString(2);
        		   itmcost=rs.getInt(3);
        ...
        <form method="post" action="counter2.jsp">
          ...
          <div class="col-sm-8">
           <%
           out.println("<p Style=\"font-size:30px;\">Sub-Total : <i class=\"fa fa-rupee\" style=\"font-size:30px;\"></i> "+" "+total+"</p>");
          %>
          </div>
          </div>
        </div>
...
<div id="feeddback" class="container">
    ...
    <div class="col-md-8">
      ...
      <div class="row">
        <div class="col-md-12 form-group">
          <button class="btn pull-right" type="submit"><span class="glyphicon glyphicon-send"> Send</span></button>
        </div>
      </div>
    </div>
  </div>
